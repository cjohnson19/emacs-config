...
#+end_src
I also prefer to have italicized font in more places like code comments or keywords in languages.
#+begin_src emacs-lisp
(custom-set-faces!
...
(setq doom-modeline-continuous-word-count-modes '(org-mode markdown-mode))
#+end_src
**** Splash Image
...
*** Visuals
**** Org Plot
Have =org-plot= use current doom theme colors.
#+begin_src emacs-lisp
(after! org-plot
