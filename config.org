...
#+end_src
*** Unicode!
Okay, this could be an absolutely terrible idea. I'm going to set my ~org-mode~
input method to be ~Agda~ because I actually really like how they set up almost
all of the math symbols that I use. I found a mailing list entry about this
exact issue [[https://lists.chalmers.se/pipermail/agda/2018/010240.html][right here]].
